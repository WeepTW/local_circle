...
for file in DB/001_ddl.sql DB/002_stored_procedures.sql DB/003_seed_demo.sql DB/006_personal_preferences.sql; do mysql local_circle_fresh_check < "$file"; done
